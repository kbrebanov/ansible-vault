...
| vault_redirect_addr                    | ''                                                               | This is the address to advertise to other Vault servers in the cluster for client redirection                                 |
| vault_cluster_addr                     | ''                                                               | This is the address to advertise to other Vault servers in the cluster for request forwarding                                 |
